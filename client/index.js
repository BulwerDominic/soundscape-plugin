...
import logo from "./Cowbell_Percussion-1.jpg";
...
render(html` <div id="plugin-container"></div> `, document.body);
...
//       <a href="/interpolate" data-navigo class="interpolate-button"
//         >Interpolate</a
//       >
//     </nav>
...
<h1 class="logo-header">More Cowbells</h1>
<img
  class="logo"
  src="${logo}"
  alt="Magenta Logo"
